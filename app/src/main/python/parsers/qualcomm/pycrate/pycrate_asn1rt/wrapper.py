...
from parsers.qualcomm.pycrate.pycrate_core.utils import TYPE_BYTES, uint_to_hex, bytes_to_uint, bytes_to_bitstr
from parsers.qualcomm.pycrate.pycrate_core.elt   import Element
from parsers.qualcomm.pycrate.pycrate_core.elt   import _with_json
